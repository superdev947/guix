...
class CreateAccountHostessScreen extends Component {
    constructor(props) {
        super(props)
        this.state = {
            name : '',
            ...
            <Container>
                ...
                <Content style={[S.PH25]}>
                    <View style={[S.MT80, S.MB50, S.BKW]}>
                        ...
                        <Item regular style={[S.PH10, S.MT10, {backgroundColor:COLOR.BackgroundPrincipal}]}>
                            <Icon name='map-pin' type='Feather' style={[S.InputIcon]} />
                            <Input 
                    ...
                    <Button block style={[S.ButtonSuccess]} onPress={()=>this.Login('Guide')}>
...
export default connect(mapStateToProps, mapDispatchToProps)(CreateAccountHostessScreen)
