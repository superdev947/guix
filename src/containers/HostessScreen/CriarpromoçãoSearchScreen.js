...
import { Container, Content, Icon, Title, Text, Item, Input, CheckBox, Footer, FooterTab, Button } from 'native-base'
...
export class CriarpromoçãoSearchScreen extends Component {
    constructor(props) {
        super(props)
        this.state = {
            Promotion:'',
        ...
        return (
            <Container>
                <Headers 
                    ...
                    body={<Title style={[S.CLI]}>Criar promoção</Title>}
                    color={COLOR.whiteColor}
                />
                <Content style={[S.BKW]}>
                    <View style={[S.PH20, S.PV10]}>
                        <View style={[S.ROW, S.MT15]}>
                            <Text style={[S.F18, S.CLB]}>Promoção exclusiva para: </Text>
                            <Text style={[S.F18, S.FW700, S.CLS]}>Loja havainas...</Text>
                        </View>
                        {
                            photo?
                        ...
                        <Slider
                            thumbTintColor={COLOR.InputBorder}
                        ...
                        />
                        <Button block style={[S.ButtonSuccess, S.MV20]} onPress={() => this.setState({modalVisible:!modalVisible})}>
                ...
                <Modal
                    ...
                    <View style={[S.modalCenteredView]}>
                        <TouchableOpacity style={[S.modalView, S.Radius5,S.PH100]} 
                            onPress={()=>{this.setState({modalVisible:!modalVisible}), this.props.navigation.goBack()}}
                        >
...
export default connect(mapStateToProps, mapDispatchToProps)(CriarpromoçãoSearchScreen)
