...
export class GuiasvinculadosScreen extends Component {
    constructor(props) {
        super(props)
        this.state = {
        }
            ...
            <Container>
                ...
                <Content>
                    <View style={[S.PH30, S.PV10]}>
                        <Text style={[S.F40, S.FW700, S.Tleft, S.CLS]}>Guias vinculados</Text>
                        {userList.map((item, key)=>
                            <UserItem {...item} key={key}/>
                        )}
                    </View>
                </Content>
            </Container>
...
export default connect(mapStateToProps, mapDispatchToProps)(GuiasvinculadosScreen)
