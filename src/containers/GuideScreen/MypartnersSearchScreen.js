...
export class MypartnersSearchScreen extends Component {
    constructor(props) {
        super(props)
        this.state = {
        }
            ...
            <Container>
                ...
                <Content style={[S.BKPrincipal]}>
                    <View style={[S.PH20, S.PV10]}>
                        ...
                        <TouchableOpacity onPress={()=>navigate('ReservecardsScreen')}>
                            <PartnersItem1/>    
                        </TouchableOpacity>
                        <TouchableOpacity>
                            <PartnersItem1/>
...
export default connect(mapStateToProps, mapDispatchToProps)(MypartnersSearchScreen)
